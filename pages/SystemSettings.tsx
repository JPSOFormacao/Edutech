  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
            <h2 className="text-2xl font-bold text-gray-900">Configuração de Branding</h2>
            <p className="text-sm text-gray-500">Personalize o logótipo, ícone e nome da plataforma.</p>
        </div>
      </div>
              ...
              <div className="bg-gray-50 p-6 rounded-lg border border-gray-200 flex flex-col items-center justify-center gap-6">
                  ...
                  <p className="text-xs text-gray-400">Aparência na Barra Lateral</p>
                   ...
                   <div className="flex items-center gap-2">
                       ...
                       <span className="text-sm font-medium text-gray-700">Separador do Browser</span>
                   </div>
              </div>
          </div>
      </div>
